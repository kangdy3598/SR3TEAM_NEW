...
_uint CLoading::Loading_Stage()
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_MonsterHPFrame", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/UI/HPBar.png", TEX_NORMAL)), E_FAIL);
